...
<header className="flex flex-col border-b-[0.5px] pb-4 bordeer-[#000000]">
{/* Top  01 */}
...
<Link href="/" className="poppins-regular-600 text-[14px] leading-[24px] text-center text-[#FAFAFA] underline tracking-wide ml-9">ShopNow</Link>
</div>
...
<Image src="/Logo.png" alt="logo" height={24}width={118} className="mr-14"/>
...
<Image className="cursor-pointer" src="/Search.png" alt="icon-explorer" height={24}width={24}/>
</div>



<div className="flex items-center ">
<Image className="cursor-pointer" src="/Heart.png" alt="icon-explorer" height={32}width={24}/>
</div>

<div className="flex items-center ">
<Image className="cursor-pointer" src="/Shop.png" alt="icon-explorer" height={32}width={24}/>
</div>
